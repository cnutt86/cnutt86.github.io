...
* For fun
    * Deep Learning
    * Computer Vision
    * Projects about cocoa

Here is an _ordered list_ showing some things I love about chai
...
I love Python & Chai so much, here is that picture from the top of my project AGAIN, but this time, in the BODY of my project!
...
A line break, like this one below - helps me make sense of what I'm reading, especially when I've had so much chai that my vision goes a little blurry

---

I could also add things to my project like links, tables, quotes, and HTML blocks - but I'm starting to get a cracking headache.  Must be chai time.
